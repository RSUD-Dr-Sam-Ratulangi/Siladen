export const saveIdUser: string = 'SAVE_ID_USER';
export const saveName: string = 'SAVE_NAME';
...
export const saveRuangan: string = 'SAVE_RUANGAN';
export const saveAge: string = 'SAVE_AGE';
export const saveAgeNo: string = 'SAVE_AGE_NO';
export const saveSelectedAgeType: string = 'SAVE_SELECTED_AGE_TYPE';
export const saveAsuransi: string = 'SAVE_ASURANSI';
export const saveJenisKelamin: string = 'SAVE_JENIS_KELAMIN';
export const saveWaktuMendapatPelayanan: string =
  'SAVE_WAKTU_MENDAPAT_PELAYANAN';

//   RINCIAN KEJADIAN
export const saveWaktuInsiden = 'SAVE_WAKTU_INSIDEN';
...
export const saveProbabilitas = 'SAVE_PROBABILITAS';
